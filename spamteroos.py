...
def countdown(time_sec):
	try:
		while time_sec:
			...
			timeformat = '\033[1;97m[\033[00;03m•\033[00;07m] Silakan Menunggu Dalam Waktu \033[00;09m{:02d}:{:02d}'.format(mins,secs)
...
█▀ █▀█ ▄▀█ █▀▄▀█ ▀█▀ █▀▀ █▀█ █▀█ █▀█ █▀
▄█ █▀▀ █▀█ █░▀░█ ░█░ ██▄ █▀▄ █▄█ █▄█ ▄█
| 1.Spam |  2.Sama Aja Kayak Nomor 1 | 3.Report Bug 999.Keluar| """)
...
def start(): # Def Untuk Start Tools
    ...
    if pil == "1":
        ...
        os.system("xdg-open https://wa.me/6283841852697")
        print (f"{Y}${W} Terima Kasih Telah Menyampaikan Eror, Saya Akan Segera Memperbaiki")
        tanya()
    elif pil == "999":
        print (f"{W}[{R}!{W}] Berhasil Keluar")
        sys.exit()

start() # Memulai Tools

#Jika Saya Salah Mohon Dimaaf Kan 
#Semua Script Saya Hanya Hasil Recode 
# 8/3/24
